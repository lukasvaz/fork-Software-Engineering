...
path('api/incomes/<int:pk>/',rest_views.IncomesViewSet.as_view({'patch':'partial_update','put':'update','delete':'destroy'})),
path('api/incomes/',rest_views.IncomesViewSet.as_view({'post':'create'})),
path('api/outcomes/<int:pk>/',rest_views.OutcomesViewSet.as_view({'patch':'partial_update','put':'update','delete':'destroy'})),
